...
COPY public."DirectMessage" (id, text, "createdAt", "senderId", "receiverId") FROM stdin;
\.
...
COPY public."User" (id, email, name, username, "avatarUrl", "oauthId", "istwoFactor", "twoFactorAuthSecret", "onlineStatus", "blockedUsernames", "createdAt", "updatedAt", confirmed) FROM stdin;
\.
...
SELECT pg_catalog.setval('public."Userstats_id_seq"', 1, false);
